...
public final class CaptureActivity extends Activity implements
	...
	public void handleDecode(Result rawResult, Bitmap barcode, float scaleFactor) {
		...
		Log.i("handleDecode", "scan:"+result);
		String[] array = result.split("\\|");
		if(array.length == 16){
			Intent data=new Intent();
			data.putExtra("clxh", array[0]);
			data.putExtra("clsbdm", array[1]);
			data.putExtra("dzrs", array[2]);
			data.putExtra("csys", array[3]);
			data.putExtra("cllx", array[4]);
			data.putExtra("hpzl", array[5]);
			data.putExtra("ywlx", array[6]);
			data.putExtra("ggbh", array[7]);
			data.putExtra("useprop", array[8]);
			data.putExtra("fdjh", array[9]);
			data.putExtra("qlj", array[10]);
			data.putExtra("hlj", array[11]);
			data.putExtra("zj", array[12]);
			data.putExtra("lsh", array[13]);
			data.putExtra("hphm", array[14]);
			data.putExtra("dpid", array[15]);
			setResult(20, data);
		}
		CaptureActivity.this.finish();
	}
